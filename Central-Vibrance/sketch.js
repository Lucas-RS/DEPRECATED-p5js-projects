...
const defaultPresets = {
    "Line Dot Turn":{"_other":{"userCode":"if (random() < 0.4) {\n  for (let i = 0; i < particles.length; i++) {\n    particles[i].color = generateColor()\n  }\n}\n\nif (frameCount == 1) {\n  loop()\n}\n\nif (frameCount == 20) {\n  noLoop()\n}"},"settings.canvas.width":1080,"settings.canvas.height":1080,"settings.originRadius.max":400,"settings.particleCount":40,"settings.mouseAttractsParticles":true,"settings.velocitySettings.maxVelocity":20,"settings.velocitySettings.changeForceChance":1,"settings.velocitySettings.magnitudeBoundaries.min":10,"settings.velocitySettings.magnitudeBoundaries.max":10,"settings.velocitySettings.changeDirectionChance":0.23,"settings.velocitySettings.rotationBoundaries.min":90,"settings.velocitySettings.rotationBoundaries.max":90,"settings.velocitySettings.randomForce.randomForceChance":0,"settings.colors.showParticles":true,"settings.colors.particleSettings.particleWidth":16,"settings.colors.particleSettings.particleHeight":16,"settings.colors.particleSettings.drawOutline":false,"settings.colors.particleColorType":"randomHSLA","settings.colors.randomRGBA.redMin":160,"settings.colors.randomRGBA.greenMin":131,"settings.colors.randomRGBA.greenMax":204,"settings.colors.randomHSLA.hueMin":109,"settings.colors.randomHSLA.saturationMin":109,"settings.colors.randomHSLA.saturationMax":123,"settings.colors.randomHSLA.lightnessMin":55,"settings.lines.strokeWeight":2,"settings.lines.changeSpeedConnected":false,"settings.lines.maxLineDist":70,"settings.Attract Particles to Center":false,"settings.centerAttractionForce.chance":0.05},
    "Connected Points":{
